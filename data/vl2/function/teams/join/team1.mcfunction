...
execute if score temp1 vl_math > temp2 vl_math if data storage vl2:teams {balance:1} run return 0

team join vl_team1 @s
tp @e[tag=team1,tag=spawn,sort=random,limit=1]
